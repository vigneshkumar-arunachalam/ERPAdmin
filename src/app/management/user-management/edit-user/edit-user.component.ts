...
export class EditUserComponent implements OnInit {
  ...
  EditUser(id: any) {
    ...
    console.log("user id", this.userID_Edit)
    ...
    editCR_req.contract_id = this.userID_Edit;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response != '') {
        ...
        this.addUserForm1.patchValue({
          ...
          'displayName': response.contract_remarks[0].firstName,
          'firstName': response.contract_remarks[0].remark_dt,
          'lastName': response.contract_remarks[0].remark_desc,
          'userName': response.contract_remarks[0].firstName,
          'password': response.contract_remarks[0].remark_dt,
          'confirmPassword': response.contract_remarks[0].remark_desc,
          'passwordDetails': response.contract_remarks[0].firstName,
          'confirmPasswordDetails': response.contract_remarks[0].remark_dt,
          'department': response.contract_remarks[0].remark_desc,
          'designation': response.contract_remarks[0].firstName,
          'FIN': response.contract_remarks[0].remark_dt,
          'bankAccountNO': response.contract_remarks[0].remark_desc,
          'address': response.contract_remarks[0].firstName,
          'dob': response.contract_remarks[0].remark_dt,
          'age': response.contract_remarks[0].remark_desc,
          'epfcpfStatus': response.contract_remarks[0].firstName,
          'sinda': response.contract_remarks[0].remark_dt,
          'socso': response.contract_remarks[0].remark_desc,
        });
        this.addUserForm3.patchValue({

          'smsNotif': response.contract_remarks[0].firstName,
          'phoneNumber': response.contract_remarks[0].remark_dt,
          'emailNotif': response.contract_remarks[0].remark_desc,
          'emailID': response.contract_remarks[0].firstName,
          'cmsContactPhone': response.contract_remarks[0].remark_dt,
          'cmsAlternativeContactPhone': response.contract_remarks[0].remark_desc,
          'cmsAlternativeSupportMail': response.contract_remarks[0].firstName,
          'cmsAlternativeSupportWebsite': response.contract_remarks[0].remark_dt,
          'bccEmailID': response.contract_remarks[0].remark_desc,
          'pettyCashColorCode': response.contract_remarks[0].firstName,
          'Signature': response.contract_remarks[0].remark_dt,
          'Staff': response.contract_remarks[0].remark_desc,
          'ProbationIn': response.contract_remarks[0].firstName,
          'permissionAs': response.contract_remarks[0].remark_dt,
          'oneInputControl': response.contract_remarks[0].remark_desc,

        });
        this.addUserForm7.patchValue({

          'VOIPCreditManager': response.contract_remarks[0].remark_desc,
          'VOIPSuspendAccount': response.contract_remarks[0].remark_dt,
          'ProductStockReportUpdate': response.contract_remarks[0].remark_desc,
          'CurrenctStockShow': response.contract_remarks[0].remark_desc,
          'RateCatelogShow': response.contract_remarks[0].firstName,
          'ActPurchasePriceShow': response.contract_remarks[0].remark_dt,
          'CalncallMenuShow': response.contract_remarks[0].remark_desc,
          'ResellerShoppingMenu': response.contract_remarks[0].remark_dt,
          'PublicTaskManager': response.contract_remarks[0].remark_desc,
          'PersonalTaskManager': response.contract_remarks[0].remark_desc,
          'DailyWorkReport': response.contract_remarks[0].firstName,
          'Mailer': response.contract_remarks[0].remark_dt,
          'HelpDesk': response.contract_remarks[0].remark_desc,
          'SpecialLogin': response.contract_remarks[0].remark_desc,
          'LeftSideTurnOverChart': response.contract_remarks[0].firstName,
          'IndividualPettyCashCreditPersonSelect': response.contract_remarks[0].remark_dt,
          'IndividualPettyCashandFromDate_cb': response.contract_remarks[0].remark_desc,
          'IndividualPettyCashandFromDate_date': response.contract_remarks[0].remark_desc,
          'ApprovalDelete': response.contract_remarks[0].firstName,
          'billingFromDt': response.contract_remarks[0].remark_dt,
          'billingToDt': response.contract_remarks[0].remark_desc,
          'billingFilterMonth': response.contract_remarks[0].remark_desc,
          'IndividualPettyCashFromDate_TextBox': response.contract_remarks[0].firstName,
          'IndividualPettyCashFromDate_Date': response.contract_remarks[0].remark_dt,
        });

        this.addUserForm8.patchValue({
          'DashBoard': response.contract_remarks[0].remark_desc,
        });
        this.addUserForm5.patchValue({
          'RecurringCheckerList': response.contract_remarks[0].remark_desc,
          'StockPreApproval': response.contract_remarks[0].remark_desc,
        });
      }
