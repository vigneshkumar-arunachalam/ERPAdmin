...
export class UserManagementComponent implements OnInit {
  ...
  userList(data: any) {
    ...
    let api_userList: any = new Object();
    api_req.moduleType = "quotation";
    api_req.api_url = "admin/user_list"
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_userList.action = "user_list";
  
    api_userList.off_set = list_data.offset;
    api_userList.limit_val = list_data.limit;
    api_userList.current_page = "";
    api_req.element_data = api_userList;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response) {
        ...
        this.sno_list=response.sno_val;
